  ...
  return (
    <section className="w-10/12 mx-auto my-20">
      ...
      <div className="flex flex-col md:flex-row gap-10">
        ...
        {/* Image Section */}
        <div className="md:w-1/2 rounded-xl overflow-hidden shadow-2xl border border-[#CE8946] h-[500px]">
          <img
            src={item.image}
            alt={item.title}
        ...
        <div className="md:w-1/2 flex flex-col justify-end h-[500px]">
          <div className="bg-[#fdfbc8] p-6 rounded-xl shadow-lg flex flex-col gap-4">
            <h1 className="text-3xl font-bold text-[#CE8946]">{item.title}</h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-4">
              <button
                ...
                className="px-6 py-3 bg-[#CE8946] text-white font-semibold rounded-md hover:opacity-90 transition shadow-md hover:shadow-lg"
              >
                Add to Cart
              </button>
              <button
